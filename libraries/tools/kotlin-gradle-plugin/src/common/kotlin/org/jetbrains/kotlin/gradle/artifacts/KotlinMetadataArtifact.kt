...
internal val KotlinMetadataArtifact = KotlinTargetArtifact { target, apiElements, _ ->
    ...
    apiElements.attributes.setAttribute(target.project, Usage.USAGE_ATTRIBUTE) { target.project.usageByName(KotlinUsages.KOTLIN_METADATA) }
    apiElements.attributes.setAttribute(target.project, Category.CATEGORY_ATTRIBUTE) { target.project.categoryByName(Category.LIBRARY) }
