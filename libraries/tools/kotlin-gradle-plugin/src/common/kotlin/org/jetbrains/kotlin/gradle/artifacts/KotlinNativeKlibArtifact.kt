...
internal val KotlinNativeKlibArtifact = KotlinTargetArtifact { target, apiElements, _ ->
    ...
    apiElements.outgoing.attributes.setAttribute(target.project, target.project.artifactTypeAttribute) { NativeArtifactFormat.KLIB }
...
internal fun createKlibArtifact(
    ...
    with(compilation.project.configurations.getByName(apiElementsName)) {
        ...
        attributes.setAttribute(compilation.project, compilation.project.artifactTypeAttribute) { NativeArtifactFormat.KLIB }
    }
}
