    ...
    override fun setUpSourceSetDefaults(sourceSet: DefaultKotlinSourceSet) {
        ...
        dependencyConfigurationWithMetadata.forEach { (configurationName, metadataName) ->
            project.configurations.maybeCreateResolvable(metadataName).apply {
                attributes.setAttribute(project, KotlinPlatformType.attribute) { KotlinPlatformType.common }
                attributes.setAttribute(project, Usage.USAGE_ATTRIBUTE) { project.usageByName(KotlinUsages.KOTLIN_API) }
                ...
                if (project.isKotlinGranularMetadataEnabled) {
                    attributes.setAttribute(project, Usage.USAGE_ATTRIBUTE) { project.usageByName(KotlinUsages.KOTLIN_METADATA) }
                }
            }
        }
